...
return [
    ...
    */
    ...
    // Por defecto es 'layouts::app', que apunta al espacio de nombres
    // `layouts` de arriba (resources/views/layouts). Aqui los layouts son
    // componentes Blade y viven todos juntos en components/layouts: el de
    // invitado (`guest`) y el de la aplicacion (`app`). Tener la mitad en
    // cada sitio es como se pierde media hora buscando cual manda.
    ...
    */
    ...
    // Se queda en false a proposito: el build CSP-safe evita el `new Function`
    // de Alpine, pero Flux no funciona con el (sus componentes usan
    // expresiones que ese evaluador no admite, y fallan en silencio). Por eso
    // la CSP lleva 'unsafe-eval'. Ver docs/adr/0011-csp-y-unsafe-eval.md
    'csp_safe' => false,
