...
/*
 * Roles y permisos de spatie/laravel-permission, en la base del TENANT.
 * RONDA-PLAN-MAESTRO.md sec. 8.3
 *
 * La feature de `teams` del paquete queda desactivada a proposito: el
 * aislamiento entre clientes lo da la base de datos (ADR 0002), no una
 * columna de equipo. Mezclar las dos cosas duplica la frontera y crea la
 * duda de cual manda.
 *
 * Publicada con `vendor:publish --tag=permission-migrations` y movida aqui.
 */
